...
В профиле можно заполнить информацию о себе.

Перейти на страницу профиля следует из меню.
...
Если вы - участник проекта «Активные меры содействия занятости", ФИО изменить самостоятельно нельзя. Если корректировки всё-таки потребуются, необходимо написать в поддержку [support@odin.study](mailto:support@odin.study)[﻿](https://mailto:support@odin.study/).
